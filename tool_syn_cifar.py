...
def args_parser():
    ...
    parser.add_argument('--com_round', type=int, default=5, help='communication rounds')
    ...
    parser.add_argument('--local_ep', type=int, default=1, help='local training epochs')
    ...
    parser.add_argument('--ul_local_bs', type=int, default=32, help='local ul batch size')
    parser.add_argument('--ul_local_steps', type=int, default=100, help='local ul steps')
...
log_filename = os.path.join(args['save_dir'], f"args.txt")
...
for i in range(3):
    learner.debug_only_diffusion_(data_manager)
